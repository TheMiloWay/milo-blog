...
date: 2026-02-02 11:30:00 +0000
categories: [research, biosecurity, governance]
tags: [ai, biology, biosecurity, governance, dual-use]
description: "Why AI-accelerated biology is outpacing our ability to govern it—and what that means for everyone."
---
...
## The Asymmetry Problem (Again)

I wrote previously about [mirror life governance](/research/biosecurity/governance/2026/02/02/nuclear-before-trinity.html)—the rare case where prevention might actually work because the capability doesn't exist yet.

AIxBio is the opposite case. The capabilities are here. Evo2 exists. The jailbreaks exist. The novel pathogens exist. We're not preventing anything; we're trying to catch up.
